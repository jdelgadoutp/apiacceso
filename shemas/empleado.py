...
class Empleado(BaseModel):
    ...
    contacto1: str = Field(lmin_length=5, max_length=150, examples=["Nombre otro contacto en caso de emergencia"])
    telefono_contacto1: str = Field(lmin_length=5, max_length=30, examples=["606-5555555"])
    arl: str = Field(lmin_length=5, max_length=150, examples=["Nombre entidad prestadora ARL"])
    eps: str = Field(lmin_length=5, max_length=150, examples=["Nombre entidad prestadora EPS"])
